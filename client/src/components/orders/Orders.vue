                ...
                <div class="d-flex">
                    <div class="p-title-box">
                        <div class="p-title-right">
                            <h4 class="p-title" v-if="!userStore.user || userStore.user.type != 'EC'">Orders</h4>
                    ...
                    <div class="card-body">
                        <div class="row mb-2">
                            ...
                            <div class="col-xl-4 d-flex justify-content-end align-items-end">
                                <div v-if="!userStore.user || (userStore.user && (userStore.user.type == 'EM' || userStore.user.type == 'C'))">
                                    <button type="button" class="btn btn-add px-4 align-self-end" @click="addOrder">
