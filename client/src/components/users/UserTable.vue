    ...
    <table class="table align-middle mt-4">
        <thead class="table-light">
            <tr>
                ...
                <th v-if="showBlockButton" class="text-center">Blocked</th>
        ...
        <tbody>
            <tr v-for="user in users" :key="user.id">
                ...
                <td>
                    <div class="form-check form-switch text-center" v-if="showBlockButton">
                ...
                <td class="text-center" v-if="showEditButton">
                    <div class="d-flex justify-content-center">
